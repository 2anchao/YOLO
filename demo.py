...
CLASSES = ("person","car","non-motor","tricycle")

Color = [[0, 255, 0],[0, 64, 128],[0, 0, 255],[255, 0, 0]]

def decoder(pred):
    '''
    pred (tensor) 1x7x7x(10+class_num)
    return (tensor) box[[x1,y1,x2,y2]] label[...]
    '''
    grid_num = cfg.Inputs["grid_num"]
    boxes=[]
    cls_indexs=[]
    probs = []
    cell_size = 1./grid_num
    pred = pred.data
    pred = pred.squeeze(0) #7x7x(10+class_num)
